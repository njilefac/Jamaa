...
dotnet publish $projectPath -c Release -r win-x64 --self-contained true -p:PublishTrimmed=false -p:PublishReadyToRun=false -o $publishDir -p:Version=$Version -p:InformationalVersion=$Version
