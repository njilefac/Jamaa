...
public partial class MemberCard : Card
{
    ...
    public MemberCard()
    {
        ...
        this.PointerPressed += (s, e) =>
        {
            ...
            if (selectionModel != null && this.DataContext is Libota.Data.Models.Members.MemberData member)
            {
    ...
    private void UpdateSelection()
    {
        ...
        if ((this.Parent as ItemsControl)?.DataContext is MemberListViewModel vm && this.DataContext is Libota.Data.Models.Members.MemberData member)
        {
            var index = vm.Members.IndexOf(member);
            if (index != -1)
            {
